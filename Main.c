...
#pragma config(Sensor, in6,    potentiometerMoGoLift, sensorPotentiometer) //NOT IN USE
...
#pragma config(Motor,  port4,           motorDriveLeftFront, tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port5,           motorDriveRightMiddleBack, tmotorServoContinuousRotation, openLoop, reversed) //Expander C and D
#pragma config(Motor,  port6,           motorDriveLeftMiddleBack, tmotorServoContinuousRotation, openLoop, reversed) // Expander A and B
#pragma config(Motor,  port7,           motorDriveRightFront, tmotorServoContinuousRotation, openLoop)
...
#pragma config(Motor,  port10,          motorArmRight, tmotorServoContinuousRotation, openLoop)
...
#define MINI_4_BAR_POTENTIOMETER_EXTENDED_VALUE 	1900
#define MINI_4_BAR_POTENTIOMETER_RETRACTED_VALUE 	250
#define MINI_4_BAR_POTENTIOMETER_PARALLEL_VALUE		1910
