...
#pragma config(Motor,  port6,           motorArmRight, tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port7,           motorArmLeft,  tmotorServoContinuousRotation, openLoop, reversed)
#pragma config(Motor,  port8,           motorDriveRightFrontMiddle, tmotorServoContinuousRotation, openLoop, reversed)
