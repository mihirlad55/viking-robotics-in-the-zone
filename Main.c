...
#pragma config(Motor,  port6,           motorArmLeftBottom, tmotorServoContinuousRotation, openLoop, reversed) // Expander C
#pragma config(Motor,  port7,           motorArmRightBottomAndLeftTop,  tmotorServoContinuousRotation, openLoop) // Expander A and B
#pragma config(Motor,  port8,           motorDriveRightFrontBack, tmotorServoContinuousRotation, openLoop, reversed)
#pragma config(Motor,  port9,           motorArmRightTop, tmotorServoContinuousRotation, openLoop, reversed) // Expander D
