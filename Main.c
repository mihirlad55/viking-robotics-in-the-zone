...
#define MOGO_LIFT_POTENTIOMETER_EXTENDED_VALUE	3850
#define MOGO_LIFT_POTENTIOMETER_RETRACTED_VALUE	1770
...
#define MINI_4_BAR_POTENTIOMETER_EXTENDED_VALUE 	3300
#define MINI_4_BAR_POTENTIOMETER_RETRACTED_VALUE 	1280
...
#define GOLIATH_INTAKE_POWER	45
...
void userMini4BarPIDControl(short goalPoint, WaitForAction stopWhenMet)
{
	...
	while ( (stopWhenMet == WAIT && abs(error) > 90) || (stopWhenMet == WAIT_NONE
