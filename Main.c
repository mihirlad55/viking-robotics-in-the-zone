...
enum StateExtension { STATE_EXTENSION_EXTENDED, STATE_EXTENSION_RETRACTED, STATE_EXTENSION_HALFWAY, STATE_EXTENSION_STATIONARY };
...
task tMini4Bar()
{
	...
	else if (tMini4BarGoalState == STATE_EXTENSION_STATIONARY) mini4BarPIDControl(MINI_4_BAR_POTENTIOMETER_STATIONARY_VALUE, WAIT, ON_STALL_EXIT, tMini4BarIsDataLogged);
