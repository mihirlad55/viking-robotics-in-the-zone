...
#pragma config(Motor,  port6,           motorDriveLeftFrontMiddle, tmotorServoContinuousRotation, openLoop) //Expander D and C
#pragma config(Motor,  port7,           motorDriveLeftBack, tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port8,           motorDriveRightFrontMiddle, tmotorServoContinuousRotation, openLoop, reversed) //Expander A and B
